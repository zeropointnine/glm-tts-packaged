...
import sys
sys.path.append(os.path.dirname(os.path.abspath(__file__)) + '/modules/LaughterSegmentation')
...
def build_model(model_path, device, sr):
...
def recog_laughter(audio_path, model, output_dir, input_sec=7, batch_size=10):
    sr = 24000
    over_lap_sec = 2.
