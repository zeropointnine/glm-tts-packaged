...
from modules.wavlm_ecapa import s3prl_util
    ...
    def __init__(self, feat_dim=80, channels=512, emb_dim=192, global_context_att=False,
        ...
        if feat_type == 'fbank':
            ...
            if config_path is None:
                ...
                assert feat_type == "wavlm_large"
                self.feature_extract = s3prl_util.load_feature_extract_for_wavlm_large()
                t2 = time.time()
                # print("time for load s3prl:", t2 - t1)
